...
| **C6** | EventFlow demo | *original* | `eventflow-order-service`, `eventflow-payment-service`, `eventflow-infra`, `eventflow-devin-integration` | Four-repo event-driven architecture demo (scaffolded from scratch). |
