...
| **License** | MIT |
| **Default Branch** | `main` |
| **Challenges** | [OtterWorks Workshop](../workshops/otterworks/README.md) — ETL modernization (cron to Airflow), framework upgrades (Java 8 to 17), language translation (Flask to FastAPI), incident response (chaos engineering), security remediation (CVE triage), API contract audit, test coverage; [Incident Response Demo](../demos/observability-sre/incident-response-demo.md) |
