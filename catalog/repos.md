...
| **License** | MIT |
| **Default Branch** | `main` |
| **Challenges** | [OtterWorks Workshop](../workshops/otterworks/README.md) — ETL modernization (cron to Airflow), framework upgrades (Java 8 to 17), language translation (Flask to FastAPI), incident response (chaos engineering), security remediation (CVE triage), API contract audit, test coverage; [Docs-as-Code and Developer Experience](../demos/technical-documentation/docs-as-code-and-devex-demo.md) |
