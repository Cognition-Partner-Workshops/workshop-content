...
Event-driven reactions are **responsive** — they fire in real time when something happens. This is different from scheduled sessions (covered in [Automations](../product/08-automations.md)) which run on a cadence regardless of events.
