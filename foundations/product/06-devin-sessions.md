...
The prompt you provide at session start is the agent's initial instruction. The quality of this prompt significantly impacts the quality of the output (see [What to Give AI](../theory/04-what-to-give-ai.md)).
