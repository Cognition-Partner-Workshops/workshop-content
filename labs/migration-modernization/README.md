...
| uc-spring-boot-upgrade-microservice-extraction | [Framework Upgrade](framework-upgrade.md), [Containerization & Microservice Extraction](containerization-microservice-extraction.md), [Cloud-Native Refactor](cloud-native-refactor.md), [Repetitive Framework Upgrades](repetitive-framework-upgrades.md), [Legacy Modernization Combined](legacy-modernization-combined.md), [One-Shot Tech Debt Remediation](one-shot-tech-debt-remediation.md) |
...
- See the [.NET Cloud-Native Modernization Workshop](../../workshops/specialties/technical-domains/modernization/dotnet-cloud-native/README.md) for .NET Monolith Decomposition + Integration Testing + Bug Investigation
- See the [Legacy Modernization Workshop](../../workshops/specialties/technical-domains/modernization/legacy/README.md) for a unified workshop offering both COBOL (Track A) and Oracle Forms (Track B) tracks
